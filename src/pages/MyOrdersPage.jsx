...
export default function MyOrdersPage() {
  ...
  return (
    <div className="min-h-screen px-4 py-16 bg-gradient-to-b from-gray-50 to-gray-100">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-4xl font-bold text-gray-800 mb-10 text-center">My Orders</h2>
        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-8">
            {orders.map((order) => (
              <div
                key={order.id}
                className="bg-white rounded-2xl shadow-md p-6 border border-gray-200 transition hover:shadow-lg"
              >
                {/* Header */}
                ...
                <div className="flex justify-between items-center pt-4 border-t mt-4">
                  <div className="text-sm text-gray-600">
                    Paid via: <span className="capitalize font-medium text-gray-800">{order.paymentMethod}</span>
                  </div>
